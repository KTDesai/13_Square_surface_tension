...
class PV_coupling
{
  ...
  void velocity_compute_source_matrix(std::vector<Cell>, std::vector<Face>);
  ...
  void pressure_compute_rate_of_change_matrix(std::vector<Cell> , double);
  void pressure_compute_source_matrix(std::vector<Cell>, std::vector<Face>);
  void pressure_compute_source_matrix_vol_based(std::vector<Cell>);

   void pressure_compute_diffusion_matrix(std::vector<Face>, std::vector<double>, std::vector<Boundary>, int, Scalar_boundary_field);
  // void pressure_compute_diffusion_matrix(std::vector<Face>, std::vector<double>, std::vector<Boundary>, int);
  void pressure_compute_diffusion_matrix_vol_based(std::vector<Cell>, std::vector<double>, std::vector<Boundary>, int);
  ...
  void alpha_convection_discretization(std::vector<Face>, std::vector<Cell>, std::vector<Boundary>, Scalar_boundary_field, Vector_boundary_field);
